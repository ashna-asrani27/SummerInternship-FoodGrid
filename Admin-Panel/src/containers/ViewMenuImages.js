...
export default class ViewMenuImages extends Component
{
    constructor(props)
    {
        super(props);
    ...
    componentDidMount()
    {
        ...
        axios.get('http://localhost:8000/restaurantrequest/'+this.props.match.params.id)
            .then(response=>{
                ...
                console.log('data:',this.state.restaurantrequests.menuimages);
            ...
            <CRow>
                ...
                <CCard>
                  ...
                  {/* {
                    ...
                    <MenuImage restaurantrequests={this.state.restaurantrequests}/>
